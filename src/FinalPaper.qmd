...
Batting |>
  ...
  geom_point() +
  geom_line() +
  geom_vline(xintercept = c(1942, 1961, 1977, 1994, 2006), linetype = "dashed", color = "red") +
  labs(title = "Batting AVG by Year",
       x = "Year",
       y = "League-Wide Average") +
  theme_light()
```
...
Batting |>
  ...
  geom_line(color = "blue") +
  geom_vline(xintercept = c(1942, 1961, 1977, 1994, 2006), linetype = "dashed", color = "red") +
  labs(title = "Strikeout Rate by Year",
       x = "Year",
       y = "League-Wide Average")  +
  theme_light()
```
...
acf(ts_HR, main = "Homerun ACF")
pacf(ts_HR, main = "Homerun PACF")
```
...
plot(ts_HR_demean, type = "line",
     ...
     xlab = "Year",
     xaxt = "n",
     main = "Homeruns by Year, Demeaned")
axis(1, at = seq(1, 100, by = 4), labels = seq(1920, 2018, by = 4))
abline(reg = lm(ts_HR_demean ~ time(ts_HR_demean)), col = "blue")

# ACFs and PACFs for demeaned AVG ts
acf(ts_HR_demean, main = "Homeruns ACF, Demeaned")
pacf(ts_HR_demean, main = "Homeruns Rate PACF, Demeaned")
```
